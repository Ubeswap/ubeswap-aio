...
import { SquidWidget } from 'components/swap/SquidWidget'
...
export default function Swap() {
  ...
  const handleOutputSelect = useCallback(
    (outputCurrency: Token) => onCurrencySelection(Field.OUTPUT, outputCurrency),
    [onCurrencySelection]
  )
  ...
  return (
    <>
      <span style={{ maxWidth: '430px' }}>
        <Option active={!isCrossChainView} onClick={() => setIsCrossChainView(false)}>
          Celo
        </Option>
        <Option active={isCrossChainView} onClick={() => setIsCrossChainView(true)}>
          Cross-chain
        </Option>
      </span>
