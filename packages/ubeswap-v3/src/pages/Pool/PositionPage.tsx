    ...
    function modalHeader() {
        return (
            <>
                ...
                <div className={"c-p mv-05 fs-075"}>Collecting fees will withdraw currently available fees for you.</div>
                                ...
                                <div className={"f f-ac ms_w-100 ms_mb-1 mxs_fd-c"}>
                                    ...
                                    <div className={"f f-ac mxs_w-100"}>
                                        <MouseoverTooltip text={`Current pool fee.`}>
                                            <Badge className={"mr-05 fs-085"}>{new Percent(existingPosition?.pool?.fee || 100, 1_000_000).toSignificant()}%</Badge>
                                        </MouseoverTooltip>
                            ...
                            <Card isDark={false} classes={"p-1 br-12"}>
                                <div className={"f c mb-05"}>
                                    ...
                                    {_fiatValueOfLiquidity?.greaterThan(new Fraction(1, 100)) ? (
                                        <span className={"fs-2"}>${_fiatValueOfLiquidity.toFixed(2, { groupSeparator: "," })}</span>
                                    ) : (
                                ...
                                <Card isDark classes={"p-1 br-12"}>
                                    <div className={"flex-s-between mb-1"}>
                                        ...
                                        <div className={"f f-ac"}>
                                            ...
                                            {typeof ratio === "number" && !removed ? <Badge className={"ml-05 fs-075"}>{inverted ? ratio : 100 - ratio}%</Badge> : null}
                                        </div>
                                    </div>
                                    <div className={"flex-s-between"}>
                                        ...
                                        <div className={"f f-ac"}>
                                            ...
                                            {typeof ratio === "number" && !removed ? <Badge className={"ml-05 fs-075"}>{inverted ? 100 - ratio : ratio}%</Badge> : null}
                                        </div>
                                    </div>
                                </Card>
                            </Card>
                                    ...
                                    <div className={"flex-s-between"}>
                                        {_fiatValueOfFees?.greaterThan(new Fraction(1, 100)) ? (
                                            <span className={"fs-2 c-g"}>
                                                ${+_fiatValueOfFees.toFixed(2, { groupSeparator: "," }) < 0.01 ? "<0.01" : _fiatValueOfFees?.toFixed(2, { groupSeparator: "," })}
                                            </span>
                                        ) : (
                                            <span className={"fs-2"}>$-</span>
                                        )}
                            ...
                            <Card isDark={false} classes={"p-1 br-12"}>
                                <div className={"flex-s-between mb-1 fs-085"}>
                                    <div className={"f f-ac mxs_fd-c"}>
                                        <div className={"mr-05 fs-1 mxs_w-100 mxs_mr-0"}>Price range</div>
                                ...
                                <div className={"f f-ac mb-1 ms_fd-c"}>
                                    <Card isDark classes={"w-100 p-1 br-12"}>
                                        <AutoColumn gap="1" justify="center">
                                            ...
                                            {inRange && <span className={"c-lg fs-075 ta-c"}>Your position will be 100% {currencyBase?.symbol} at this price.</span>}
                                        </AutoColumn>
                                    </Card>
                                    ...
                                    <Card isDark classes={"w-100 p-1 br-12"}>
                                        <AutoColumn gap="1" justify="center">
                                            ...
                                            {inRange && <span className={"c-lg fs-075 ta-c"}>Your position will be 100% {currencyQuote?.symbol} at this price.</span>}
                                        </AutoColumn>
                                    </Card>
                                </div>
                                <CurrentPriceCard
